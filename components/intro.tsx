      ...
      <section id="home" ref={ref} className='mb-[100px] min-w-screen relative scroll-mt-[110px]'>
          <div className='flex flex-col-reverse md:flex-row items-center justify-center 3xl:mt-[170px] lg:mt-[130px] mx-auto gap-[100px] sm:[50px] lg:gap-[200px] mt-[100px]'>
              <motion.div initial={{ opacity: 0 ,y: 100}} animate={{ opacity: 1 ,y: 0}} transition={{duration: 0.4 ,type:"tween"}}>
                  ...
                  <div className='text-[34px] lg:text-[47px] font-bold text-[#462C2C]'>Quality Assuarance Engineer</div>
                  <div className='text-[14px] lg:text-[16px] font-normal text-[#685454] w-[300px] md:w-[500px] text-center md:text-justify'>Undergraduate at University of Moratuwa , seeking to apply competent testing skills with focus on collaboration and passion</div>
